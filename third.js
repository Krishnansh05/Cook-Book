...
const sampleRecipe = {
    ...
    procedure: "Step 1. Gather all ingredients.  Step 2. SPreheat the oven to 300 degrees F (150 degrees C). Step 3. ring water to a boil in a medium pot; stir in rice. Step 4. Reduce heat to medium-low, cover, and simmer until rice is tender and water has been absorbed, 20 to 25 minutes. Step 5. Mix rice vinegar, sugar, and salt in a small bowl. Step 6. Gently stir into cooked rice in the pot and set aside. Step 7. Lay nori sheets on a baking sheet. Step 8. Heat nori in the preheated oven until warm, 1 to 2 minutes. Step 9. Center 1 nori sheet on a bamboo sushi mat. Use wet hands to spread a thin layer of rice on top. Step 10. Arrange 1/4 of the crabmeat, avocado, cucumber, and pickled ginger over rice in a line down the center. Step 11. Lift one end of the mat and roll it tightly over filling to make a complete roll. Step 12. Repeat with remaining ingredients. Step 13. Use a wet, sharp knife to cut each roll into 4 to 6 slices.",
